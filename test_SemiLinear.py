from pde.SemiLinearPDE import ProblemNNLapVar
...
# with metroplis-hasting heuristic insertion coef is not used.
...
# check if the directory of the name exists or not
# if not, make the directory

# find the home folder of the config file
if args.config is not None:
