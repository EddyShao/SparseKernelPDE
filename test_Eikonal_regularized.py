...
if os.path.exists('eikonal_regularized_exact.npz'):
    print('Loading the exact solution from file')
    data = np.load('eikonal_regularized_exact.npz')
    x_grid_full = data['x_grid_full']
    XX = data['XX']
    YY = data['YY']
    test_truth = data['test_truth']
else:
