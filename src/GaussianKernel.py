...
#         return jax.vmap(self.Lap_gauss_X_c, in_axes=(None, None, None, 0))(X, S, c, Xhat)
    ...
    @partial(jax.jit, static_argnums=(0,))
    def Grad_E_gauss_X_c(self, X, S, c, xhat):
    ...
    # @shapeParser
    @partial(jax.jit, static_argnums=(0,))
    def Grad_E_gauss_X_c_Xhat(self, X, S, c, Xhat):
        return jax.vmap(self.Grad_E_gauss_X_c, in_axes=(None, None, None, 0))(X, S, c, Xhat)


    
    @partial(jax.jit, static_argnums=(0,))
    def Grad_B_gauss_X_c(self, X, S, c, xhat):
    ...
    # @shapeParser
    @partial(jax.jit, static_argnums=(0,)) 
    def Grad_B_gauss_X_c_Xhat(self, X, S, c, Xhat):
        return jax.vmap(self.Grad_B_gauss_X_c, in_axes=(None, None, None, 0))(X, S, c, Xhat)
